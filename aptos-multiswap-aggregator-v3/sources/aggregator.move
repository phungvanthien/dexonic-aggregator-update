module aggregator::multiswap_aggregator_v2 {
    ...
    public entry fun setup_default_pools(admin: &signer) acquires AggregatorConfig, DEXRegistry {
        ...
        // Add APT/APDOGE pool
        let apt_apdoge_key = create_pool_key<AptosCoin, 0xe92e80d3819badc3c8881b1eaafc43f2563bac722b0183068ffa90af27917bd8::aptosdoge::AptosDoge>();
        ...
        let apdoge_apt_key = create_pool_key<0xe92e80d3819badc3c8881b1eaafc43f2563bac722b0183068ffa90af27917bd8::aptosdoge::AptosDoge, AptosCoin>();
