...
export function LoginModal({ isOpen, onClose, onSwitchToSignup }: LoginModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <Card className="bg-black/90 backdrop-blur-md border border-yellow-500/20 w-full max-w-md">
        <CardHeader className="relative">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-400 mt-2">Sign in to your AptosSwap account</p>
          </div>
        </CardHeader>
        ...
        <CardContent className="p-6 pt-0">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input type="checkbox" className="rounded border-gray-700 text-yellow-500 focus:ring-yellow-500" />
          ...
          <div className="text-center mt-6">
            <p className="text-gray-400">
              ...
              <button onClick={onSwitchToSignup} className="text-yellow-400 hover:text-yellow-300 font-semibold">
                Sign up
              </button>
            </p>
          </div>
